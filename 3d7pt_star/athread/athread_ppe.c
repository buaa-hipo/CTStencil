...
void fatal(char *s);
int computeTempCPE(DEFINED_DATATYPE *temp[2], int nt, int nz, int ny, int nx, int DIMT, int DIMX, int DIMY, int DIMZ, int NTH);
...
int main(int argc, char **argv)
{
    ...
    int CPE_out = computeTempCPE(tempCPE, NUMTIMESTEPS, LAYERS, NUMROWS, NUMCOLS, DIMT, DIMX, DIMY, DIMZ, NTH);
