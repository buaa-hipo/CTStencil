            ...
            else
            {
                for (global_y = left_y_load + R * (t + 1), y = R * (t + 1); global_y < right_y_load - R * (t + 1); global_y++, y++)
                {
                    for (global_x = left_x_load + R * (t + 1), x = R * (t + 1); global_x < right_x_load - R * (t + 1); global_x++, x++)
                    {
                        ...
                        T1 = S1_z_block_t * blockSize_y * blockSize_x + y * blockSize_x + x;
                        T2 = S2_z_block_t * blockSize_y * blockSize_x + y * blockSize_x + x;
                        tOut_ptr[x] = (a - f) * local_tIn_0[C] + e * local_tIn_0[B1] + d * local_tIn_0[B2] + e * local_tIn_0[T1] + d * local_tIn_0[T2] + e * local_tIn_0[W1] + d * local_tIn_0[W2] + e * local_tIn_0[E1] + d * local_tIn_0[E2] + e * local_tIn_0[S1] + d * local_tIn_0[S2] + e * local_tIn_0[N1] + d * local_tIn_0[N2];
                        total_float_ops += 26;
                    }
                    while (DMA_push != 1)
                        ;
