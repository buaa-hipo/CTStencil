    ...
    for (t = 1; t <= nt; t++)
    {
        ...
        for (y = R * t; y < ny - R * t; y++)
        {
            for (x = R * t; x < nx - R * t; x++)
            {
                ...
                C23 = C22 + 1;
                C24 = C22 + 2;
                temp[out][C12] = 2 * temp[in][C0] + 4 * temp[in][C1] + 5 * temp[in][C2] + 4 * temp[in][C3] + 2 * temp[in][C4] \
                + 4 * temp[in][C5] + 9 * temp[in][C6] + 12 * temp[in][C7] + 9 * temp[in][C8] + 4 * temp[in][C9] \
                + 5 * temp[in][C10] + 12 * temp[in][C11] + 15 * temp[in][C12] + 12 * temp[in][C13] + 5 * temp[in][C14] \
                + 4 * temp[in][C15] + 9 * temp[in][C16] + 12 * temp[in][C17] + 9 * temp[in][C18] + 4 * temp[in][C19] \
                + 2 * temp[in][C20] + 4 * temp[in][C21] + 5 * temp[in][C22] + 4 * temp[in][C23] + 2 * temp[in][C24];
            }
        }
    }
    return out;
