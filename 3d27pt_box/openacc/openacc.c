...
#pragma acc parallel loop copyin(nz, ny, nx, nyx, t, z, y, x, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17, c18, c19, c20, c21, c22, c23, c24, c25, c26) annotate(readonly(nz, ny, nx, nyx, t, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17, c18, c19, c20, c21, c22, c23, c24, c25, c26, global_In, global_Out))
        for (z = R * t; z < nz - R * t; z++)
        {
            for (y = R * t; y < ny - R * t; y++)
            {
                ...
                for (x = R * t; x < nx - R * t; x++)
                {
                    ...
                    C25 = C16 + 1;
                    C26 = C17 + 1;
                    global_Out[C0] = c0 * global_In[C0] + c1 * global_In[C1] + c2 * global_In[C2] + c3 * global_In[C3] + c4 * global_In[C4] + c5 * global_In[C5] + c6 * global_In[C6] + c7 * global_In[C7] + c8 * global_In[C8] + c9 * global_In[C9] + c10 * global_In[C10] + c11 * global_In[C11] + c12 * global_In[C12] + c13 * global_In[C13] + c14 * global_In[C14] + c15 * global_In[C15] + c16 * global_In[C16] + c17 * global_In[C17] + c18 * global_In[C18] + c19 * global_In[C19] + c20 * global_In[C20] + c21 * global_In[C21] + c22 * global_In[C22] + c23 * global_In[C23] + c24 * global_In[C24] + c25 * global_In[C25] + c26 * global_In[C26];
                }
            }
        }
    }
